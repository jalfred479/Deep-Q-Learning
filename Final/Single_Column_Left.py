...
def main(load='False'):
	csvfile = open(os.getcwd() + "/SingleColumnLeft/SingleColumnLeft.csv", 'w')
	...
	train_writer = tf.summary.FileWriter(os.getcwd() + "/SingleColumnLeft/train", sess.graph)
	...
	train_writer.close()
	env.monitor.close()
	saver.save(sess, os.getcwd() + "/SingleColumnLeft/Weights");
