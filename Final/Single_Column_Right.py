...
def main(load='False'):
	csvfile = open(os.getcwd() + "/SingleColumnRight/SingleColumnRight.csv", 'w')
	...
	train_writer = tf.summary.FileWriter(os.getcwd() + "/SingleColumnRight/train", sess.graph)
	...
	train_writer.close()
	env.monitor.close()
	saver.save(sess, os.getcwd() + "/SingleColumnRight/Weights");
